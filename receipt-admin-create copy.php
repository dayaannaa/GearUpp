...
if ($result) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Increment the latest receipt ID to get the available receipt ID
        $available_receipt_id = $current_receipt_id + 1;
    } else {
        // If no rows were returned (i.e., the table is empty), set initial values
    ...
    // Step 2: Fetch product data from the receipt_products table based on the latest receipt_id
    ...
    // Step 3: Fetch service data from the receipt_services table based on the latest receipt_id
...
<?php 
    ...
    if ($result) {
        ...
        if ($row) {
            ...
            // echo "No rows found in receipt_products table.";
        }
    } else {
...
<?php
    // Fetch the total cost of products
...
// Fetch the total cost of services
