  ...
  <main id="main">
    ...
    <section id="services" class="services">
      ...
      <div class="col-xl-3 col-md-4">
        <div class="icon-box">
          <span class="material-symbols-outlined text-warning col-xl-4 col-md-4">shopping_cart</span>
          <div class="icon-box-content">
            <p class="text-white fs-4"></p> 
            <h3><a href="products_print.php" target="blank">Products</a></h3>
          </div>
        </div>
        </div>
      </div>
      ...
      <div class="col-xl-3 col-md-4">
        <div class="icon-box">
          ...
          <div class="icon-box-content">
            <p class="text-white fs-4"></p> 
            <h3><a href="Services_print.php" target="blank">Services</a></h3>
          </div>
        </div>
        </div>
      </div>
